...
timingData = json.loads(urllib.request.urlopen("https://api.racetime.tk/v1/result/bd5549bd-0873-42a4-ae05-dfadafc5601b/All%20Categories/42.2%20Km/overall").read().decode())
...
speed = []
splits = []
bibs = ["43503", "42029","42047","43526","43546","43785","43858"]
